...
# # report_month1.run(reference_data=reference, current_data=month1)
# # report_month1.save_html("reports/drift_month1.html")
# report_month1.run(reference_data=reference, current_data=month1)
# report_month1.save_html("reports/drift_month1.html")
...
# # snapshot_month2 = 
# report_month2.run(reference_data=reference, current_data=month2)
# report_month2.save_html("reports/drift_month2.html")
...
# report_month3.run(reference_data=reference, current_data=month3)
# report_month3.save_html("reports/drift_month3.html")
